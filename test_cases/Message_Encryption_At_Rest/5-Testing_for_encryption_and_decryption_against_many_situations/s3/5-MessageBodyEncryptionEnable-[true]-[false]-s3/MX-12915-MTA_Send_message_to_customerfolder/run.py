...
#uuid1 = mxos_operations_MessageBodyEncryption.fetch_latest_message_uuid(mx1_mxos1_host_ip,mx1_mxos1_port,'testuser1@openwave.com','customerfolder')
#
...
#
#body_check_flag1 = messagebody1.count('an attachement,haha,are you OK')
...
body_check_flag2 = messagebody2[1].count('an attachement,haha,are you OK')
...
uuid2 = mxos_operations_MessageBodyEncryption.fetch_latest_message_uuid(mx1_mxos1_host_ip,mx1_mxos1_port,'testuser1@openwave.com','customerfolder')
