...
remote_operations.remote_operation(mx1_host1_ip,root_account,root_passwd,'su - {0} -c \'imconfcontrol -install -key \"/*/common/hostInfo=blobtier=Cassandra:blobcluster:9162\";imconfcontrol -install -key \"/site1-inbound-standardmta-direct/mta/subAddressAllowedIPs=127.0.0.1\n10.37.2.214\";imconfcontrol -install -key \"/*/mta/subAddressAllowedIPs=127.0.0.1\n10.37.2.214\";imconfcontrol -install -key \"/*/common/messageBodyEncryptionEnabled=false\";imconfcontrol -install -key \"/*/mss/compressionEnabled=false\"\''.format(mx_account),0)
...
#smtp_operations.fast_send_mail(mx1_mta1_host_ip,mx1_mta1_port,'testuser2',['testuser1+customerfolder@{}'.format(default_domain)])
