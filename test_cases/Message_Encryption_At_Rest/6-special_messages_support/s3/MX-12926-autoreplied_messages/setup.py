...
mxos_auto_reply.set_autoreply(mx1_mxos1_host_ip,mx1_mxos1_port,'testuser2@openwave.com','echo','1529106000','internal:%0athis is an autoreply message for internal accounts%0aexternal:%0aathis is an autoreply message for external accounts%0a')


basic_class.mylogger_record.info('step4:send 1 message to testuser2 to INBOX')
smtp_operations.fast_send_mail(mx1_mta1_host_ip,mx1_mta1_port,'testuser1',[test_account_base+'2'])
