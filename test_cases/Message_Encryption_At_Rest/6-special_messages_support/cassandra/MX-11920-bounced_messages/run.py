...
body_check_flag1 = messagebody1.count('Mail System Error - Returned Mail with Subject')
...
body_check_flag2 = messagebody2[1].count('Mail System Error - Returned Mail with Subject')
