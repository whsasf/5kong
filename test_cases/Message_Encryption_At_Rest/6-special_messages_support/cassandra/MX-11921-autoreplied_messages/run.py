...
body_check_flag1 = messagebody1.count('this is an autoreply message for internal accounts')
...
body_check_flag2 = messagebody2[1].count('this is an autoreply message for internal accounts')
