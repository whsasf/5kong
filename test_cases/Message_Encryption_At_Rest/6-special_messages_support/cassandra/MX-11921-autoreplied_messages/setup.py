...
mx1_imapserv_host1_imap4Port,mx1_imapserv_host1_ip,mx1_mxos_host1_ip,ASE_key128,AES_mode1,mx1_mta_host1_SMTPPort,mx1_mta_host1_ip,mx1_mxos_host1_eureka_port,mx1_mxos_host1_ip,mx1_mss_host2_ip,mx1_mss_host1_ip,mx1_popserv_host1,mx1_popserv_host1_pop3Port,mx_account,mx1_host1_ip,root_account,root_passwd,test_account_base,default_domain = \
global_variables.get_values('mx1_imapserv_host1_imap4Port','mx1_imapserv_host1_ip','mx1_mxos_host1_ip','ASE_key128','AES_mode1','mx1_mta_host1_SMTPPort','mx1_mta_host1_ip','mx1_mxos_host1_eureka_port','mx1_mxos_host1_ip','mx1_mss_host2_ip','mx1_mss_host1_ip','mx1_popserv_host1','mx1_popserv_host1_pop3Port','mx_account','mx1_host1_ip','root_account','root_passwd','test_account_base','default_domain')
...
basic_class.mylogger_record.info('step3:setup autoreply on account2')

mxos_auto_reply.set_autoreply(mx1_mxos_host1_ip,mx1_mxos_host1_eureka_port,'testuser2@openwave.com','echo','1529106000','internal:%0athis is an autoreply message for internal accounts%0aexternal:%0aathis is an autoreply message for external accounts%0a')


basic_class.mylogger_record.info('step4:send 1 message to testuser2 to INBOX')
smtp_operations.fast_send_mail(mx1_mta_host1_ip,mx1_mta_host1_SMTPPort,'testuser1',[test_account_base+'2'])
