...
basic_class.mylogger_record.info('step3:send 1 message to testuser1 to customerfolder')
for i in range(1,201):
    smtp_operations.fast_send_mail(mx1_mta_host1_ip,mx1_mta_host1_SMTPPort,'testuser2',['testuser1+customerfolder@openwave.com'])
#myimap = imap_operations.IMAP_Ops(mx1_imapserv_host1_ip,mx1_imapserv_host1_imap4Port)
#myimap.imap_login('testuser1','testuser1')
#myimap.imap_select()
#for i in range(1,201):
