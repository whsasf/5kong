...
mx1_mxos2_host_ip,ASE_key192,AES_mode5,mx1_mta1_port,mx1_mta1_host_ip,mx1_mxos1_port,mx1_mxos1_host_ip,mx1_mss2_host_ip,mx1_mss1_host_ip,mx1_pop1_host,mx1_pop1_port,mx_account,mx1_host1_ip,root_account,root_passwd,test_account_base,default_domain = \
global_variables.get_values('mx1_mxos2_host_ip','ASE_key192','AES_mode5','mx1_mta1_port','mx1_mta1_host_ip','mx1_mxos1_port','mx1_mxos1_host_ip','mx1_mss2_host_ip','mx1_mss1_host_ip','mx1_pop1_host','mx1_pop1_port','mx_account','mx1_host1_ip','root_account','root_passwd','test_account_base','default_domain')
...
mxos_operations_MessageBodyEncryption.create_passphrase(mx1_mxos1_host_ip,mx1_mxos1_port,str(cuid),AES_mode5,ASE_key192)
