...
#1 set keys as below (including imapproxy and poopproxy settings):
#
...
#  /*/popserv/popProxyPort=20110
#  /*/popserv/popProxyHost:     [pop://scality2:20110]
#  /*/imapserv/imapProxyHost:     [imap://scality2:20143]
#  /*/imapserv/imapProxyPort=20143
#  /*/imapserv/enableMOVE=true
#
#
#2 create 6 account on both envs :
...
for i in range(1,6):
    ...
    myimap = imap_operations.IMAP_Ops(mx2_imapserv_host1_ip,mx2_imapserv_host1_imap4Port)
    ...
    flag,send_result = remote_operations.remote_operation(mx2_host1_ip,'su - {0} -c "cat log/mta.log"'.format(mx_account),root_account,root_passwd,1,'delivered',1)
    time.sleep(5)
    myimap.imap_select()
    ...
    flag,send_result = remote_operations.remote_operation(mx2_host1_ip,'su - {0} -c "cat log/mta.log"'.format(mx_account),root_account,root_passwd,1,'delivered to test folder',1)
