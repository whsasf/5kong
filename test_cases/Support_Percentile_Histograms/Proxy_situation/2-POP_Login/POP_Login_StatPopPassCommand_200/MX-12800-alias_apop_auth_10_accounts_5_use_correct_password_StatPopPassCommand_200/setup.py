...
remote_operations.remote_operation(mx1_mxos_host2_ip,root_account,root_passwd,'su - {0} -c "~/lib/imservctrl killStart mss mxos"'.format(mx_account),0)
