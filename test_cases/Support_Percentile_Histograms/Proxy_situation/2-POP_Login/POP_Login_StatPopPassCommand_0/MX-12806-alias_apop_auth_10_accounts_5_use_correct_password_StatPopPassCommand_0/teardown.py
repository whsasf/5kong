...
remote_operations.remote_operation(mx1_host1_ip,'su - {0} -c \'for ((i=1;i<=10;i++));do imdbcontrol DeleteAlias u$i {2};done\''.format(mx_account,test_account_base,mx1_default_domain),root_account,root_passwd,0)
remote_operations.remote_operation(mx2_host1_ip,'su - {0} -c \'for ((i=1;i<=10;i++));do imdbcontrol DeleteAlias u$i {2};done\''.format(mx_account,test_account_base,mx2_default_domain),root_account,root_passwd,0)


basic_class.mylogger_record.info('step1:delete 10 accounts')
remote_operations.remote_operation(mx1_host1_ip,'su - {0} -c \'for ((i=1;i<=10;i++));do account-delete {1}$i@{2};done\''.format(mx_account,test_account_base,mx1_default_domain),root_account,root_passwd,1,'Mailbox Deleted Successfully',10)
remote_operations.remote_operation(mx2_host1_ip,'su - {0} -c \'for ((i=1;i<=10;i++));do account-delete {1}$i@{2};done\''.format(mx_account,test_account_base,mx2_default_domain),root_account,root_passwd,1,'Mailbox Deleted Successfully',10)

basic_class.mylogger_record.info('step2:restore config keys')
remote_operations.remote_operation(mx1_host1_ip,'su - {0} -c \'imconfcontrol -install -key \"/*/common/loginAliases=false\";imconfcontrol -install -key \"/*/common/perfStatThresholds=\";imconfcontrol -install -key \"/*/common/reportParamsInterval=60\";imconfcontrol -install -key \"/*/common/badPasswordDelay=1\";imconfcontrol -install -key \"/*/common/maxBadPasswordDelay=90\";imconfcontrol -install -key \"/*/imapserv/imapProxyHost=\";imconfcontrol -install -key \"/*/popserv/popProxyPort\";imconfcontrol -install -key \"/*/popserv/allowAPOP=false\";imconfcontrol -install -key \"/*/mxos/defaultPasswordStoreType=sha512\";imconfcontrol -install -key \"/*/mxos/trustedClient=false\"\''.format(mx_account),root_account,root_passwd,0)
remote_operations.remote_operation(mx1_host1_ip,'su - {0} -c \'imconfcontrol -install -key \"/*/common/loginAliases=false\";imconfcontrol -install -key \"/*/common/perfStatThresholds=\";imconfcontrol -install -key \"/*/common/reportParamsInterval=60\";imconfcontrol -install -key \"/*/common/badPasswordDelay=1\";imconfcontrol -install -key \"/*/common/maxBadPasswordDelay=90\";imconfcontrol -install -key \"/*/popserv/allowAPOP=false\";imconfcontrol -install -key \"/*/mxos/defaultPasswordStoreType=sha512\";imconfcontrol -install -key \"/*/mxos/trustedClient=false\"\''.format(mx_account),root_account,root_passwd,0)
