...
# (abort) calculate and set hamc value for each account
...
#basic_class.mylogger_record.info('Runing setup testcase:mx-12467-alias_auth_crammd5_10_accounts_half_pass_half_fail')
