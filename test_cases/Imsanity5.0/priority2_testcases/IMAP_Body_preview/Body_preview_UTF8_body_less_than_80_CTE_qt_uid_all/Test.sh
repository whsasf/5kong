...
if [ $firstlinedata_count -eq 2 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_UTF8_body_less_than_80_CTE_qt_uid_all test successfully!"  "IMAP:Body_preview_UTF8_body_less_than_80_CTE_qt_uid_all"  2
	Result=0
else
  prints "IMAP:Body_preview_UTF8_body_less_than_80_CTE_qt_uid_all test failed!"  "IMAP:Body_preview_UTF8_body_less_than_80_CTE_qt_uid_all"  1
  Result=1
fi
summary "IMAP:Body_preview_UTF8_body_less_than_80_CTE_qt_uid_all" $Result
