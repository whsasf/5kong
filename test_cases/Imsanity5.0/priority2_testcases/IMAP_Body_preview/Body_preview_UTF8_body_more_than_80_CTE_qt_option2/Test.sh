...
if [ $firstlinedata_count -eq 3 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_UTF8_body_more_than_80_CTE_qt_option2 test successfully!"  "IMAP:Body_preview_UTF8_body_more_than_80_CTE_qt_option2"  2
	Result=0
else
  prints "IMAP:Body_preview_UTF8_body_more_than_80_CTE_qt_option2 test failed!"  "IMAP:Body_preview_UTF8_body_more_than_80_CTE_qt_option2"  1
  Result=1
fi
summary "IMAP:Body_preview_UTF8_body_more_than_80_CTE_qt_option2" $Result
