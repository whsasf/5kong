...
if [ $firstlinedata_count -eq 2 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_range test successfully!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_range"  2
	Result=0
else
  prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_range test failed!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_range"  1
  Result=1
fi
summary "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_range" $Result
