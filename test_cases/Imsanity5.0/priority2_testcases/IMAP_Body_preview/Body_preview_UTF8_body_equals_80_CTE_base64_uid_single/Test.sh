...
if [ $firstlinedata_count -eq 1 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_single test successfully!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_single"  2
	Result=0
else
  prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_single test failed!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_single"  1
  Result=1
fi
summary "IMAP:Body_preview_UTF8_body_equals_80_CTE_base64_uid_single" $Result
