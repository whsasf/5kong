...
if [ $firstlinedata_count -eq 3 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_qt_uid_option1 test successfully!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_qt_uid_option1"  2
	Result=0
else
  prints "IMAP:Body_preview_UTF8_body_equals_80_CTE_qt_uid_option1 test failed!"  "IMAP:Body_preview_UTF8_body_equals_80_CTE_qt_uid_option1"  1
  Result=1
fi
summary "IMAP:Body_preview_UTF8_body_equals_80_CTE_qt_uid_option1" $Result
