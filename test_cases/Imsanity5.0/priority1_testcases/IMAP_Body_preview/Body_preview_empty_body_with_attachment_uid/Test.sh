...
if [ $firstlinedata_count -eq 2 -a $Result -eq 0 ];then
	prints "IMAP:Body_preview_empty_body_with_attachment_uid test successfully!"  "IMAP:Body_preview_empty_body_with_attachment_uid"  2
	Result=0
else
	prints "IMAP:Body_preview_empty_body_with_attachment_uid test failed!"  "IMAP:Body_preview_empty_body_with_attachment_uid"  1
  Result=1
fi
summary "IMAP:Body_preview_empty_body_with_attachment_uid" $Result
