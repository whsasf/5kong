...
prints "CASE 7 :  FOR UTF-8 CHARACTERS IN SUBJECT LINE " "Fetch_Envelope_for_UTF-8_characters_in_subject" 
...
echo "Subject: \x6a \x6b \x6c \x6d \x6e \x6f" >> message.tmp
echo >> message.tmp
echo "This is a test mail ..."  >> message.tmp

msg=`cat message.tmp`
prints "Sendng mail to $Sanityuser" "Fetch_Envelope_for_UTF-8_characters_in_subject" 
